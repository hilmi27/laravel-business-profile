...
<form action="{{ route('admin.client.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group ml-5">
        ...
        <div class="col-sm-7">
            ...
            <input type="text" name='link_web' class="form-control {{$errors->first('link_web') ? "is-invalid" : "" }} " value="{{old('link_web')}}" id="link_web" placeholder="example.com">
    ...
    <div class="form-group ml-5">
        ...
        <div class="col-sm-3">
            ...
            <input type="date" name='start_contract' class="form-control {{$errors->first('start_contract') ? "is-invalid" : "" }} " value="{{old('start_contract')}}" id="start_contract">
        ...
        <div class="col-sm-3">
            ...
            <input type="date" name='finish_contract' class="form-control {{$errors->first('finish_contract') ? "is-invalid" : "" }} " value="{{old('finish_contract')}}" id="finish_contract">
